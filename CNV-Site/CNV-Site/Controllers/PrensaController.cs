...
namespace CNV_Site.Controllers
{
    public class PrensaController : Controller
    {
        ...
        public ActionResult Index()
        {
           ...
           // List< CNV_Site.Areas.BackOffice.Models.Note> Notes = BO.Notes.ToList();
            ...
            SlidersNotes SN = new SlidersNotes();
            SN= SN.DtoConsultaSimple(SsN);
            ...
            var years =  Notes.Distinct().GroupBy(z=>z.create_datetime.Year);
