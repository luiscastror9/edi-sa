$(function () {
    ...
    $('#ConfiguracionData').DataTable({
        ...
        "autoWidth": false,
        "bServerSide": true,
        "sAjaxSource": "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Configuracion/ConfiguracionDataSurvey",
        "bProcessing": true,
        "language": {
    ...
    $('#ConfiguracionData tbody').on('click', '.edit-Configuracion-data', function () {
        ...
        location.href = "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Configuracion/Edit/" + id;
    ...
    $(document).on('click', '#btnNewConfiguracion', function () {
        ...
        location.href = "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Configuracion/Create"
    ...
    $('#ConfiguracionData tbody').on('click', '.delete-Configuracion-data', function () {
        ...
        if (r == true) {
            $.ajax({
                url: "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Configuracion/Delete/" + id,
                type: "POST",
                dataType: 'HTML',
