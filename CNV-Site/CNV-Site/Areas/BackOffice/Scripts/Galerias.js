$(function () {
    ...
    $('#GaleriaData').DataTable({
        ...
        "autoWidth": false,
        "bServerSide": true,
        "sAjaxSource": "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Prensa/GaleriasDataSurvey",
        "bProcessing": true,
        "language": {
    ...
    $('#GaleriaData tbody').on('click', '.edit-Galeria-data', function () {
        ...
        location.href = "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Prensa/EditGaleria/" + id;
    ...
    $('#GaleriaData tbody').on('click', '.ver-Galeria-data', function () {
        ...
        $(this).addClass('selected');
        var id = table.$(this).attr("data-row-id");
        location.href = "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Prensa/ImagenesGaleria/" + id;
    ...
    $('#GaleriaData tbody').on('click', '.delete-Galeria-data', function () {
        ...
        if (r == true) {
            $.ajax({
                url: "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Prensa/DeleteGaleria/" + id,
                type: "POST",
                dataType: 'HTML',
    ...
    $(document).on('click', '#btnNewGaleria', function () {
        ...
        location.href = "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Prensa/CreateGalerias"
