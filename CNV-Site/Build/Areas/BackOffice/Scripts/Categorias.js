$(function () {
    ...
    $('#CategoriasData').DataTable({
        ...
        "autoWidth": false,
        "bServerSide": true,
        "sAjaxSource": "http://" + window.location.host + "/BackOffice/Prensa/CategoriasDataSurvey",
        "bProcessing": true,
        "language": {
    ...
    $('#CategoriasData tbody').on('click', '.edit-Categorias-data', function () {
        ...
        location.href = "http://" + window.location.host + "/BackOffice/Default/EditCategorias/" + id;
    ...
    $(document).on('click', '#btnNewCategorias', function () {
        ...
        location.href = "http://" + window.location.host + "/BackOffice/Default/CreateCategorias"
    ...
    $('#CategoriasData tbody').on('click', '.delete-Categorias-data', function () {
        ...
        if (r == true) {
            $.ajax({
                url: "http://" + window.location.host + "/BackOffice/Prensa/DeleteCategorias/" + id,
                type: "POST",
                dataType: 'HTML',
