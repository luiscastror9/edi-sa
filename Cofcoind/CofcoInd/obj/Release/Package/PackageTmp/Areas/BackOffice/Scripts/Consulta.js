$(function () {
    ...
    $('#ConsultaData').DataTable({
        ...
        "autoWidth": false,
        "bServerSide": true,
        "sAjaxSource": "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Default/ConsultaDataSurvey",
        "bProcessing": true,
        "language": {
    ...
    $('#ConsultaData tbody').on('click', '.edit-Consulta-data', function () {
        ...
        location.href = "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Default/ViewConsulta/" + id;
    ...
    $('#ConsultaData tbody').on('click', '.edit-ResponderConsulta-data', function () {
        ...
        $(this).addClass('selected');
        var id = table.$(this).attr("data-row-id");
        location.href = "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Default/ResponderConsulta/" + id;
    ...
    $(document).on('click', '#btnNewRespuestaConsulta', function () {
        ...
        location.href = "http://" + window.location.host + window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1) + "/BackOffice/Default/ResponderConsulta"
