...
namespace CofcoInd.Areas.BackOffice
{
    ...
    public partial class EntitiesBO : DbContext
    {
        ...
        public virtual int sp_Insert_Consultas(string nombreConsulta, string emailConsulta, string contenidoConsulta, string cuitConsulta, string domicilioConsulta, string residenciaConsulta, string cpConsulta, string telefonoConsulta, string ocupacionConsulta, string sexoConsulta, string provinciaConsulta, string localidadConsulta, string apellidoConsulta)
        {
            ...
            var ocupacionConsultaParameter = ocupacionConsulta != null ?
                new ObjectParameter("ocupacionConsulta", ocupacionConsulta) :
                new ObjectParameter("ocupacionConsulta", typeof(string));
    
            var sexoConsultaParameter = sexoConsulta != null ?
                new ObjectParameter("sexoConsulta", sexoConsulta) :
                new ObjectParameter("sexoConsulta", typeof(string));
    
            var provinciaConsultaParameter = provinciaConsulta != null ?
                new ObjectParameter("provinciaConsulta", provinciaConsulta) :
                new ObjectParameter("provinciaConsulta", typeof(string));
    
            var localidadConsultaParameter = localidadConsulta != null ?
                new ObjectParameter("localidadConsulta", localidadConsulta) :
                new ObjectParameter("localidadConsulta", typeof(string));
    
            var apellidoConsultaParameter = apellidoConsulta != null ?
                new ObjectParameter("apellidoConsulta", apellidoConsulta) :
                new ObjectParameter("apellidoConsulta", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Insert_Consultas", nombreConsultaParameter, emailConsultaParameter, contenidoConsultaParameter, cuitConsultaParameter, domicilioConsultaParameter, residenciaConsultaParameter, cpConsultaParameter, telefonoConsultaParameter, ocupacionConsultaParameter, sexoConsultaParameter, provinciaConsultaParameter, localidadConsultaParameter, apellidoConsultaParameter);
        }
